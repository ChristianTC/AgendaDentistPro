    ...
    ! function($) {
        ...
        CalendarApp.prototype.onDrop = function(eventObj, date) {
            ...
            CalendarApp.prototype.onEventClick = function(calEvent, jsEvent, view) {
                ...
                var $this = this;
                var form = $("<form></form>");
                form.append("<label>Contenido</label>");
            ...
            CalendarApp.prototype.onSelect = function(start, end, allDay) {
                ...
                form.find(".row")
                    .append("<div class='col-md-6'><div class='form-group'><label class='control-label'>Nombre del evento</label><input class='form-control' placeholder='Contenido' type='text' name='title'/></div></div>")
                    ...
                    .append("<option value='bg-danger'>Fuera de atencion</option>")
